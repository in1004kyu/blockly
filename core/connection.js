...
Blockly.Connection.connect_ = function(parentConnection, childConnection) {
  ...
  if (parentBlock.workspace.callBackConnectionBlock)
    parentBlock.workspace.callBackConnectionBlock();
};
...
Blockly.Connection.prototype.disconnect = function() {
  ...
  if (this.sourceBlock_.workspace.callBackConnectionBlock)
    this.sourceBlock_.workspace.callBackConnectionBlock();
};
...
Blockly.Connection.prototype.highlight = function() {
    var a, b = this.sourceBlock_.getRelativeToSurfaceXY(),
        c = this.x_ - b.x,
        b = this.y_ - b.y;
    this.type == Blockly.INPUT_VALUE || this.type == Blockly.OUTPUT_VALUE ? 
    (a = this.check_ ? this.check_[0] : "null", "PARAM" == a.toUpperCase() ? 
      a = (a = this.sourceBlock_.outputConnection) ?
       "M -20,-2 l 2,2 0,3 4,0 0,12 -4,0 0,3 -2,2" : 
       "M -20,3 l -2,2 0,3 4,0 0,12 -4,0 0,3 2,2" : 
       "BOOLEAN" == a.toUpperCase() ? (a = this.targetConnection && this.targetConnection.sourceBlock_) ?
        (a = this.targetConnection.sourceBlock_.svg_.svgPathLight_.getAttribute("d").split("z")[0],
        a += "z") : a = "M 16,0 h -20 l -11,11 11,11.5 h 20l 11,-11 -11,-11 z" : 
        (a = this.targetConnection && this.targetConnection.sourceBlock_) ? 
        (a = this.targetConnection.sourceBlock_.svg_.svgPathLight_.getAttribute("d").split("z")[0], a += "z") 
        : a = "M 10,0 h -10 a 12,9.9 0 0,0 0,19.5 h 10a 11,9.9 0 0,0 0,-19.5 z", 
...
Blockly.Connection.prototype.highlight = function() {
  ...
  if (this.type == Blockly.OUTPUT_VALUE) {
    ...
    steps = 'm -14,0 h 5 ' + Blockly.BlockSvg.NOTCH_PATH_LEFT + ' h 5';
  }
  ...
  if(this.type == Blockly.INPUT_VALUE) {
    ...
    steps = this.targetConnection ? 
    this.targetConnection.sourceBlock_.svgPath_.getAttribute("d") :
      this.sourceBlock_.svgPath_.getAttribute("d");

    Blockly.Connection.highlightedPath_ = Blockly.createSvgElement('path',
      {'class': 'blocklyHighlightedInputConnectionPath',
       'd': steps,
