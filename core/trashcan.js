...
Blockly.Trashcan = function(workspace) {
  ...
  if(this.workspace_.options.rails)
    this.ASSETS_URL = this.workspace_.options.rails;
};
 ...
 * @private
 */
Blockly.Trashcan.prototype.WIDTH_ = 42;
 ...
 * @private
 */
Blockly.Trashcan.prototype.BODY_HEIGHT_ = 42;
...
Blockly.Trashcan.prototype.body_ = null;

Blockly.Trashcan.prototype.circle_ = null;

Blockly.Trashcan.prototype.ASSETS_URL = "./assets/images/";
...
Blockly.Trashcan.prototype.createDom = function() {
  ...
  */
  this.svgGroup_ = Blockly.createSvgElement('g',
      {'class': 'blocklyTrash', 'opacity' : '0.8'}, null);
  /*
...
*/
  ...
  this.circle_ = Blockly.createSvgElement('circle', 
    {'class': 'trashCircle', 'cx' : '21', 'cy':'20','r':'30', 'fill' : '#bfbfbf', 'opacity' : '0.8'}, this.svgGroup_);
  this.body_ = Blockly.createSvgElement('image',
      {'width': 42, 'height': 42},
      this.svgGroup_);

  this.body_.setAttributeNS('http://www.w3.org/1999/xlink', 'xlink:href',
      this.ASSETS_URL + "ic_del.png");
...
Blockly.Trashcan.prototype.position = function() {
  ...
  if (this.workspace_.RTL) {
    ...
    this.left_ = metrics.viewWidth + metrics.absoluteLeft -
        this.WIDTH_ - this.MARGIN_SIDE_ - Blockly.Scrollbar.scrollbarThickness + 3;
  }
  this.top_ = metrics.viewHeight + metrics.absoluteTop -
      (this.BODY_HEIGHT_ + this.LID_HEIGHT_) - this.bottom_ + 14;
...
*/
  if(this.isOpen) {
    this.circle_.setAttribute('fill', '#ec4343');

      this.body_.setAttributeNS('http://www.w3.org/1999/xlink', 'xlink:href',
        this.ASSETS_URL + "ic_del_ovr.png");
  } else {
    this.circle_.setAttribute('fill', '#bfbfbf');
    this.body_.setAttributeNS('http://www.w3.org/1999/xlink', 'xlink:href',
      this.ASSETS_URL + "ic_del.png");
  }
};
